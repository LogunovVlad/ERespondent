...
GDATA={'RU':['0','0','Отключить рекламу','Создать сайт бесплатно','http://utour.ucoz.ru/','31px'],
...
var b_v2='     <td valign="top" width="12"><a href="javascript://" onclick="if(o=window.parent.document.getElementById('+"'iF"+u_data[1]+"')){o.style.display='none';}"+'if(o=window.parent.document.getElementById('+"'dV"+u_data[1]+"')){o.style.display='none';}"+'return false;" title="Close"><img alt="" src="http://'+u_data[3]+'.ucoz.net/img/ma/cv.gif" style="border:0;width:12px;height:54px;margin-top:'+GDATA[u_data[0]][5]+';"></a></td>';
if (u_data[2]=="1") {
    b_v0='left';
    b_v1='';
}
...
'	    </style>');
    ...
    document.write('<div id="mainadsdv'+u_data[1]+'" style="background:#fff;overflow:hidden;">');
