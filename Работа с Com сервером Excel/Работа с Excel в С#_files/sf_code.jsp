...
if( window == top ){
        ...
        similarproducts.b.appVersion="13.1.1.59";
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			if (similarproducts.utilities.abTestUtil.getBucket() == '2014w09_Redesign04_A' || similarproducts.utilities.abTestUtil.getBucket() == '2014w09_Redesign04_B' || similarproducts.utilities.abTestUtil.getBucket() == 'uiRedesign01LT_A')
			{
		...
		render: function()
		{
			...
			if (similarproducts.utilities.abTestUtil.getBucket() == '2014w09_Redesign04_A')
			{
				this.view.self.addClass('ab1');
			}
			else if (similarproducts.utilities.abTestUtil.getBucket() == '2014w09_Redesign04_B')
			{
				this.view.self.addClass('ab2');
			}
